...
import 'package:search_agent/src/utils/waveform_amplitude.dart';

import 'audio_input_controls.dart';
import 'audio_input_wave_form.dart';

enum InputMode { idle, typing, recording, processing }
...
class AudioTextInputField extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    bool isProcessing = mode == InputMode.processing;
