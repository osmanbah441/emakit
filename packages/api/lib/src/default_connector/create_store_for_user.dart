...
class CreateStoreForUserVariablesBuilder {
  ...
  CreateStoreForUserVariablesBuilder(this._dataConnect, {required  this.name,required  this.description,required  this.logoUrl,required  this.phoneNumber,});
  ...
  MutationRef<CreateStoreForUserData, CreateStoreForUserVariables> ref() {
    CreateStoreForUserVariables vars= CreateStoreForUserVariables(name: name,description: description,logoUrl: logoUrl,phoneNumber: phoneNumber,);
...
class CreateStoreForUserVariables {
  ...
  name = nativeFromJson<String>(json['name']),description = nativeFromJson<String>(json['description']),logoUrl = nativeFromJson<String>(json['logoUrl']),phoneNumber = nativeFromJson<String>(json['phoneNumber']);
